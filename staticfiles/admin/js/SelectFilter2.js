...
'use strict';
{
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            for (const p of from_box.parentNode.getElementsByTagName('p')) {
                if (p.classList.contains("info")) {
                    ...
                    // Move help content up to the top so it isn't below the select
            ...
            quickElement('span', warning_footer, '', 'id', field_id + '_list-footer-display-content');
        ...
        refresh_filtered_warning: function(field_id) {
            ...
            const warning = document.getElementById(field_id + '_list-footer-display-content');
