...
/**
 * Creates an extended regular expression object for matching content with a pattern. Differs from a
 ...
 * replacement content syntax, which supports named backreference properties via `${name}`.
 *
 * @memberOf XRegExp
 * @param {String} str String to search.
...
/**
 * Adds support for `${n}` tokens for named and numbered backreferences in replacement content, and
 * provides named backreferences to replacement functions as `arguments[0].name`. Also fixes browser
 * bugs in replacement content syntax when performing a replacement using a nonregex search value, and
